...
public interface LedgerConstants {
	...
	/* 事件转台账 未转换* */
	public static final int LEDGER_CONVERT_STATUS_NO = 0;
	/* 事件转台账 已转换* */
	public static final int LEDGER_CONVERT_STATUS_YES = 1;
	...
	//受理单编号
	public static final String ACCEPT_FORM = "acceptForm";
	...
	// 台账操作方是主办
	public static final int OPERATE_TYPE_SPONSOR = 0;
	// 台账操作方是协办
	public static final int OPERATE_TYPE_SUPPORT = 1;
	// 台账操作方是抄告
	public static final int OPERATE_TYPE_NOTICE = 2;
