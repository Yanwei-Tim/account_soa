...
@Service("reportFormValidatorImpl")
public class ReportFormValidatorImpl implements DomainValidator<ReportForm> {

	@Autowired
	protected ValidateHelper validateHelper;

	@Override
	public ValidateResult validate(ReportForm reportForm) {
...
//			result.addErrorMessage("呈报单位联系人不能为空");
//		}
