...
comment on table platformAccountRelatedPeople is
'台账相关人员表';
comment on column platformAccountRelatedPeople.name is
'相关人员姓名';
comment on column platformAccountRelatedPeople.telephone is
'联系电话';
comment on column platformAccountRelatedPeople.fixPhone is
'固话';
comment on column platformAccountRelatedPeople.issueId is
'事件ID';
comment on column platformAccountRelatedPeople.ledgerId is
'台账id';
comment on column platformAccountRelatedPeople.ledgerType is
'台账类型';
...
comment on table ledgerFeedBack
  is '台账反馈表 ';
comment on column ledgerFeedBack.id
  is '主键ID';
comment on column ledgerFeedBack.ledgerType
  is '台账类型';
comment on column ledgerFeedBack.ledgerId
  is '关联的台账的ID';
comment on column ledgerFeedBack.stepId
  is '台账的步骤ID';
comment on column ledgerFeedBack.feedBackType
  is '反馈方式';
comment on column ledgerFeedBack.feedBackOpinion
  is '反馈意见';
comment on column ledgerFeedBack.evaluateUser
  is '反馈用户';
comment on column ledgerFeedBack.createuser
  is '创建用户';
comment on column ledgerFeedBack.updateuser
  is '修改用户';
comment on column ledgerFeedBack.createdate
  is '创建时间';
comment on column ledgerFeedBack.updatedate
  is '修改时间';
