...
<link href="${resource_path}/resource/js/loadmask/jquery.loadmask.css" type="text/css" rel="stylesheet"/>
<script type="text/javascript" src="${resource_path}/resource/js/loadmask/jquery.loadmask.min.js"></script>
	...
	<div id="upload-div" class="container container_24">
		<div class="grid_24">
		    <label class="form-lbl heightAuto" id="templateVersion">
		           如数据模板不正确，您可以下载新模版：<a href='${path}/dataTransfer/downloadDataTemplate.action?dataTemplatesName=<s:property value="@com.tianque.datatransfer.ImportTemplatesSetting@getImportTemplatesVo(#parameters.cityTemplates).url"/>'><b><font color="dimgray"><i>市级用户模板</i></font></b></a>
		           <a href='${path}/dataTransfer/downloadDataTemplate.action?dataTemplatesName=<s:property value="@com.tianque.datatransfer.ImportTemplatesSetting@getImportTemplatesVo(#parameters.districtTemplates).url"/>'><b><font color="dimgray"><i>县级用户模板</i></font></b></a>
		           <a href='${path}/dataTransfer/downloadDataTemplate.action?dataTemplatesName=<s:property value="@com.tianque.datatransfer.ImportTemplatesSetting@getImportTemplatesVo(#parameters.townTemplates).url"/>'><b><font color="dimgray"><i>乡镇用户模板</i></font></b></a>
            </label>
		</div>
