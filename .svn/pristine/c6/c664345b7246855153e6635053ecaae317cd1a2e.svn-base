...
public class ThreeRecordsIssueOperate implements Serializable {
	...
	public final static int ASSIGN_CODE = 21;
	 ...
	 * 实质性办结
	 */
	public final static int COMPLETE_CODE = 31;
	private final static int BACKUPS_CODE = 32;
	public final static int SUBMIT_CODE = 41;
	public final static int DECLARE_CODE = 45;
	public final static int TURN_CODE = 50;
	 ...
	 * 阶段性办结
	 */
	public final static int PERIOD_CODE = 92;
	/*
	 * 程序性办结
	 */
	public final static int PROGRAM_CODE = 93;

	
	public final static int FEEDBACK_CODE = 42;
	
	public final static List<Integer> endCodeList = new ArrayList<Integer>();
	
	static{
		endCodeList.add(COMPLETE_CODE);
		endCodeList.add(PERIOD_CODE);
		endCodeList.add(PROGRAM_CODE);
		endCodeList.add(SUBMIT_CODE);
	}
	// 事件对接log办理描述
	...
	static {
		...
		allOperates
				.put(COMPLETE_CODE, new ThreeRecordsIssueOperate(COMPLETE_CODE,
						"实质性办结", 1, true, LedgerActionType.COMPLETE_CODE));
