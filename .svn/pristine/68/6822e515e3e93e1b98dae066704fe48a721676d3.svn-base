...
public class ThreeRecordsIssueOperationUtil {
	...
	public static String getLedgerPrefix(int type) {
		if(LedgerConstants.POORPEOPLE==type){
			return LedgerConstants.PRE_KEY_POOR_PEOPLE;
		}else if(type == LedgerConstants.STEADYWORK){
			return LedgerConstants.PRE_KEY_STEADY_WORK;
		}
